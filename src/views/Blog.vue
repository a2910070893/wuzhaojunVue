    ...
    <el-container style="height: 800px; border: 1px solid #eee">
        ...
        <el-menu :default-openeds="['1', '3']" router>
          <el-submenu index="1" v-for="(item,index) in this.$router.options.routes"
            ...
            <el-menu-item :index="children.path" v-for="(children,indexj) in item.children" @click="dd(children)">{{children.name}}{{children.path}}</el-menu-item>
    ...
    methods:{
      ...
      insertBlog(){
        ...
        dd(children){
          ...
          if (children.path === "/test3" && window.sessionStorage.getItem('userId') !="true") { alert(children.path)}
